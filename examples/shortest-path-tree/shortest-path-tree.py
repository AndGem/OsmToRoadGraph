...
if __name__ == "__main__":
    ...
    parser.add_option("-c", "--center", dest="center", action="store_true", help="set this option to compute the shortest path tree from an approximate center node [default: random node]")
    parser.add_option("-m", "--metric", dest="metric", action="store", type="string", default="travel-time", help="metric for the shortest paths. Either  'length' or 'travel-time' [default: travel-time]")
